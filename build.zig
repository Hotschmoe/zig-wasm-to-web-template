...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("zig_wasm_to_web_template", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zig_wasm_to_web_template" is the name you will use in your source code to
                // import this module (e.g. `@import("zig_wasm_to_web_template")`). The name is
